...
public class GameBoard {
	...
	public GameBoard(Team playerTeam) {
		
		this.currentTeamPlaying = playerTeam;
...
//		addNewPiece( 0, 0, Team.WHITE).piled = true;
//		addNewPiece( 6, 0, Team.BLACK).piled = true;
	...
	private Piece addNewPiece(int x, int y, Team team) {
		...
		//Se eu quiser testar com um time s�� de damas...
